    ...
    <div class="content">
        <div class="container">
            <div class="jumbotron text-center">
                ...
                <?php if ($loggedIn): ?>
                    <p>Hello, <?php echo htmlspecialchars($_SESSION['username']); ?>! You are logged in as a Provider.</p>
                <?php else: ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">View Issues data about city operations and infrastructure.</p>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Feedback from Iser</h5>
                            <p class="card-text">View feedback data about city operations and infrastructure.</p>
                            <a href="realtime_data.php" class="btn btn-custom btn-block">Real-Time Data</a>
                        </div>
                    </div>
                </div>
